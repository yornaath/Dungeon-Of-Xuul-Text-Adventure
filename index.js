...
(function($PS) {
  ...
  var gameStateFromJson = Data_Argonaut_Decode_Class.decodeJson(decodeJsonGameState);
  ...
  var saveGame = function (save) {
      return function (currentState) {
          return Effect_Aff.makeAff(function (cb) {
              var gameStateJson = Data_Argonaut_Encode_Class.encodeJson(Game_GameState.encodeJsonGameState)(currentState);
          ...
          return function __do() {
              ...
              (function () {
                  ...
                  if (readSavedStateString instanceof Data_Maybe.Just) {
                      ...
                      if (v instanceof Data_Either.Right) {
                          var v1 = Game_GameState.gameStateFromJson(v.value0);
                          if (v1 instanceof Data_Either.Left) {
                          ...
                          if (v1 instanceof Data_Either.Right) {
                              return cb(new Data_Either.Right(v1.value0))();
                          };
                          throw new Error("Failed pattern match at Engine.SaveGames (line 32, column 11 - line 35, column 35): " + [ v1.constructor.name ]);
                      };
                      throw new Error("Failed pattern match at Engine.SaveGames (line 27, column 7 - line 35, column 35): " + [ v.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Engine.SaveGames (line 23, column 3 - line 35, column 35): " + [ readSavedStateString.constructor.name ]);
              })();
              return Data_Monoid.mempty(Effect.monoidEffect(Effect_Aff.monoidCanceler))();
          };
      });
