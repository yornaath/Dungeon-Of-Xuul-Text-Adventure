  ...
  var explorationLoop = function (state) {
      return function (action) {
          if (action instanceof Game_Syntax_Spec.Idle) {
              return Control_Bind.bind(Game_Engine.bindGame)(Game_Engine.prompt(Game_Engine.engineEngineM))(function (input$prime) {
                  ...
                  if (v instanceof Data_Either.Right) {
                      ...
                      throw new Error("Failed pattern match at Game.Loop.Playing.PlayingLoop (line 48, column 11 - line 59, column 49): " + [ v.value0.value0.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Game.Loop.Playing.PlayingLoop (line 42, column 7 - line 59, column 49): " + [ v.constructor.name ]);
              });
          };
          ...
          if (action instanceof Game_Syntax_Spec.OpenCharacterSheet) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Game_Engine.bindGame)(Game_Engine.log(Game_Engine.engineEngineM)(Data_Show.show(Game_Data_Character.showCharacterSheet)(state.character)))(function () {
                  return explorationLoop(state)(Game_Syntax_Spec.Idle.value);
              });
          };
          return Control_Bind.discard(Control_Bind.discardUnit)(Game_Engine.bindGame)(Game_Engine.log(Game_Engine.engineEngineM)("I dont understand that command."))(function () {
  ...
  var playing = function (state) {
      return function (action) {
          if (state instanceof Game_Loop_Playing_PlayingState.Exploration) {
              return explorationLoop(state.value0)(action);
          };
          ...
          throw new Error("Failed pattern match at Game.Loop.Playing.PlayingLoop (line 27, column 3 - line 35, column 27): " + [ state.constructor.name ]);
      };
  };
  exports["playing"] = playing;
})(PS);
