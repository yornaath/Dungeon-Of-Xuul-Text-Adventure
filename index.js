...
(function($PS) {
  ...
  var actionParser = Control_Alt.alt(Lib_Parser.altParser(Lib_Parser.functorParser))(Control_Alt.alt(Lib_Parser.altParser(Lib_Parser.functorParser))(Control_Alt.alt(Lib_Parser.altParser(Lib_Parser.functorParser))(Control_Alt.alt(Lib_Parser.altParser(Lib_Parser.functorParser))(Control_Alt.alt(Lib_Parser.altParser(Lib_Parser.functorParser))(move)(look))(consume))(take))(Data_Functor.map(Lib_Parser.functorParser)(Game_Syntax_Spec.Combat.create)(combatParser)))(Data_Functor.map(Lib_Parser.functorParser)(Game_Syntax_Spec.Dialogue.create)(dialogueParser));
