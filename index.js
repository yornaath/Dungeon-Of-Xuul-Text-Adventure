...
(function($PS) {
  ...
  var getCharacter = function (playingState) {
      ...
      throw new Error("Failed pattern match at Game.Loop.Playing.PlayingState (line 33, column 3 - line 36, column 36): " + [ playingState.constructor.name ]);
  };
                      ...
                      return Control_Bind.bind(Game_Engine.bindGame)(Effect_Aff_Class.liftAff(Game_Engine.monadAffGame)(Engine_SaveGames["continue"]))(function (lastSave) {
                          if (lastSave instanceof Data_Either.Right) {
                              if (lastSave.value0 instanceof Game_GameState.Playing) {
                                  var v = Game_Loop_Playing_PlayingState.getCharacter(lastSave.value0.value0);
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Game_Engine.bindGame)(Game_Engine.log(Game_Engine.engineEngineM)("Continue game character: " + (v.value0.name + " \x0a")))(function () {
                          ...
                          throw new Error("Failed pattern match at Game.Loop.MainMenu (line 47, column 11 - line 58, column 39): " + [ lastSave.constructor.name ]);
                      });
                  };
          ...
          if (action instanceof Game_Syntax_Spec.Idle) {
              return Control_Bind.bind(Game_Engine.bindGame)(Game_Engine.prompt(Game_Engine.engineEngineM))(function (input$prime) {
                  ...
                  if (v instanceof Data_Either.Right) {
                      ...
                      throw new Error("Failed pattern match at Game.Loop.Playing.PlayingLoop (line 44, column 11 - line 55, column 49): " + [ v.value0.value0.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Game.Loop.Playing.PlayingLoop (line 38, column 7 - line 55, column 49): " + [ v.constructor.name ]);
              });
          };
  ...
  var playing = function (state) {
      return function (action) {
          if (state instanceof Game_Loop_Playing_PlayingState.Exploration) {
              return explorationLoop(state.value0)(Game_Syntax_Spec.Look.value);
          };
          ...
          throw new Error("Failed pattern match at Game.Loop.Playing.PlayingLoop (line 23, column 3 - line 31, column 27): " + [ state.constructor.name ]);
      };
  };
  exports["playing"] = playing;
})(PS);
