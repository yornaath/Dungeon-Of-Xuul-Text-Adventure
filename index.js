...
(function($PS) {
  "use strict";
  $PS["Game.Data.Character.GearSlot"] = $PS["Game.Data.Character.GearSlot"] || {};
  var exports = $PS["Game.Data.Character.GearSlot"];
  var Data_Argonaut_Decode_Class = $PS["Data.Argonaut.Decode.Class"];
  var Data_Argonaut_Decode_Generic_Rep = $PS["Data.Argonaut.Decode.Generic.Rep"];
  var Data_Argonaut_Encode_Class = $PS["Data.Argonaut.Encode.Class"];
  var Data_Argonaut_Encode_Generic_Rep = $PS["Data.Argonaut.Encode.Generic.Rep"];
  ...
  var genericGearSlot = new Data_Generic_Rep.Generic(function (x) {
      ...
      if (x instanceof Hands) {
          return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inl(Data_Generic_Rep.NoArguments.value)));
      };
      if (x instanceof Leggs) {
          return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inl(Data_Generic_Rep.NoArguments.value))));
      };
      if (x instanceof Feet) {
      ...
      throw new Error("Failed pattern match at Game.Data.Character.GearSlot (line 23, column 1 - line 23, column 53): " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
          return Head.value;
      };
  ...
  var eqGearSlot = new Data_Eq.Eq(Data_Generic_Rep_Eq.genericEq(genericGearSlot)(Data_Generic_Rep_Eq.genericEqSum(Data_Generic_Rep_Eq.genericEqConstructor(Data_Generic_Rep_Eq.genericEqNoArguments))(Data_Generic_Rep_Eq.genericEqSum(Data_Generic_Rep_Eq.genericEqConstructor(Data_Generic_Rep_Eq.genericEqNoArguments))(Data_Generic_Rep_Eq.genericEqSum(Data_Generic_Rep_Eq.genericEqConstructor(Data_Generic_Rep_Eq.genericEqNoArguments))(Data_Generic_Rep_Eq.genericEqSum(Data_Generic_Rep_Eq.genericEqConstructor(Data_Generic_Rep_Eq.genericEqNoArguments))(Data_Generic_Rep_Eq.genericEqSum(Data_Generic_Rep_Eq.genericEqConstructor(Data_Generic_Rep_Eq.genericEqNoArguments))(Data_Generic_Rep_Eq.genericEqSum(Data_Generic_Rep_Eq.genericEqConstructor(Data_Generic_Rep_Eq.genericEqNoArguments))(Data_Generic_Rep_Eq.genericEqConstructor(Data_Generic_Rep_Eq.genericEqNoArguments)))))))));
  var ordGearSlot = new Data_Ord.Ord(function () {
      return eqGearSlot;
  }, Data_Generic_Rep_Ord.genericCompare(genericGearSlot)(Data_Generic_Rep_Ord.genericOrdSum(Data_Generic_Rep_Ord.genericOrdConstructor(Data_Generic_Rep_Ord.genericOrdNoArguments))(Data_Generic_Rep_Ord.genericOrdSum(Data_Generic_Rep_Ord.genericOrdConstructor(Data_Generic_Rep_Ord.genericOrdNoArguments))(Data_Generic_Rep_Ord.genericOrdSum(Data_Generic_Rep_Ord.genericOrdConstructor(Data_Generic_Rep_Ord.genericOrdNoArguments))(Data_Generic_Rep_Ord.genericOrdSum(Data_Generic_Rep_Ord.genericOrdConstructor(Data_Generic_Rep_Ord.genericOrdNoArguments))(Data_Generic_Rep_Ord.genericOrdSum(Data_Generic_Rep_Ord.genericOrdConstructor(Data_Generic_Rep_Ord.genericOrdNoArguments))(Data_Generic_Rep_Ord.genericOrdSum(Data_Generic_Rep_Ord.genericOrdConstructor(Data_Generic_Rep_Ord.genericOrdNoArguments))(Data_Generic_Rep_Ord.genericOrdConstructor(Data_Generic_Rep_Ord.genericOrdNoArguments)))))))));
  var encodeJsonGearSlot = new Data_Argonaut_Encode_Class.EncodeJson(function (a) {
      return Data_Argonaut_Encode_Generic_Rep.genericEncodeJson(genericGearSlot)(Data_Argonaut_Encode_Generic_Rep.encodeRepSum(Data_Argonaut_Encode_Generic_Rep.encodeRepConstructor(new Data_Symbol.IsSymbol(function () {
          return "Head";
      }))(Data_Argonaut_Encode_Generic_Rep.encodeRepArgsNoArguments))(Data_Argonaut_Encode_Generic_Rep.encodeRepSum(Data_Argonaut_Encode_Generic_Rep.encodeRepConstructor(new Data_Symbol.IsSymbol(function () {
          return "Chest";
      }))(Data_Argonaut_Encode_Generic_Rep.encodeRepArgsNoArguments))(Data_Argonaut_Encode_Generic_Rep.encodeRepSum(Data_Argonaut_Encode_Generic_Rep.encodeRepConstructor(new Data_Symbol.IsSymbol(function () {
  ...
  var decodeJsonGearSlot = new Data_Argonaut_Decode_Class.DecodeJson(function (a) {
      return Data_Argonaut_Decode_Generic_Rep.genericDecodeJson(genericGearSlot)(Data_Argonaut_Decode_Generic_Rep.decodeRepSum(Data_Argonaut_Decode_Generic_Rep.decodeRepConstructorNoArgs(new Data_Symbol.IsSymbol(function () {
          return "Head";
      })))(Data_Argonaut_Decode_Generic_Rep.decodeRepSum(Data_Argonaut_Decode_Generic_Rep.decodeRepConstructorNoArgs(new Data_Symbol.IsSymbol(function () {
          return "Chest";
      })))(Data_Argonaut_Decode_Generic_Rep.decodeRepSum(Data_Argonaut_Decode_Generic_Rep.decodeRepConstructorNoArgs(new Data_Symbol.IsSymbol(function () {
  ...
  exports["Leggs"] = Leggs;
  exports["Feet"] = Feet;
  exports["MainHand"] = MainHand;
  exports["OffHand"] = OffHand;
  exports["ordGearSlot"] = ordGearSlot;
  exports["encodeJsonGearSlot"] = encodeJsonGearSlot;
  exports["decodeJsonGearSlot"] = decodeJsonGearSlot;
})(PS);
(function($PS) {
  "use strict";
...
(function($PS) {
  ...
  var semiringWisdom = Data_Semiring.semiringInt;
  var semiringStrength = Data_Semiring.semiringInt;
  var semiringIntelligence = Data_Semiring.semiringInt;
  var semiringEndurance = Data_Semiring.semiringInt;
  var semiringAgility = Data_Semiring.semiringInt;
  ...
  var semigroupStats = new Data_Semiring.Semiring(function (v) {
      return function (v1) {
          var wis = Data_Semiring.add(semiringWisdom)(v.value0.wis)(v1.value0.wis);
          var str = Data_Semiring.add(semiringStrength)(v.value0.str)(v1.value0.str);
          var $$int = Data_Semiring.add(semiringIntelligence)(v["value0"]["int"])(v1["value0"]["int"]);
          var end = Data_Semiring.add(semiringEndurance)(v.value0.end)(v1.value0.end);
          var agi = Data_Semiring.add(semiringAgility)(v.value0.agi)(v1.value0.agi);
          return new Stats({
              agi: agi,
              str: str,
              end: end,
      ...
      return function (v1) {
          var wis = Data_Semiring.mul(semiringWisdom)(v.value0.wis)(v1.value0.wis);
          var str = Data_Semiring.mul(semiringStrength)(v.value0.str)(v1.value0.str);
          var $$int = Data_Semiring.mul(semiringIntelligence)(v["value0"]["int"])(v1["value0"]["int"]);
          var end = Data_Semiring.mul(semiringEndurance)(v.value0.end)(v1.value0.end);
          var agi = Data_Semiring.mul(semiringAgility)(v.value0.agi)(v1.value0.agi);
          return new Stats({
              agi: agi,
              str: str,
              end: end,
  ...
  }, mkStats(1)(1)(1)(1)(1), mkStats(0)(0)(0)(0)(0));
  ...
  var total = function (statsList) {
      return Data_Foldable.foldl(Data_Foldable.foldableArray)(Data_Semiring.add(semigroupStats))(emptyStats)(statsList);
  };
...
(function($PS) {
  ...
  var statsOf = function (item) {
      ...
      throw new Error("Failed pattern match at Game.Data.Item.Equipment (line 73, column 3 - line 83, column 35): " + [ item.constructor.name ]);
  };
  var genericEquipment = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Game.Data.Item.Equipment (line 43, column 1 - line 43, column 55): " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
      ...
      if (x instanceof Data_Generic_Rep.Inr && (x.value0 instanceof Data_Generic_Rep.Inr && (x.value0.value0 instanceof Data_Generic_Rep.Inr && (x.value0.value0.value0 instanceof Data_Generic_Rep.Inr && (x.value0.value0.value0.value0 instanceof Data_Generic_Rep.Inr && (x.value0.value0.value0.value0.value0 instanceof Data_Generic_Rep.Inr && (x.value0.value0.value0.value0.value0.value0 instanceof Data_Generic_Rep.Inr && (x.value0.value0.value0.value0.value0.value0.value0 instanceof Data_Generic_Rep.Inr && x.value0.value0.value0.value0.value0.value0.value0.value0 instanceof Data_Generic_Rep.Inr)))))))) {
          return new Staff(x.value0.value0.value0.value0.value0.value0.value0.value0.value0);
      };
      throw new Error("Failed pattern match at Game.Data.Item.Equipment (line 43, column 1 - line 43, column 55): " + [ x.constructor.name ]);
  });                              
  var encodeJsonEquipment = new Data_Argonaut_Encode_Class.EncodeJson(function (a) {
      return Data_Argonaut_Encode_Generic_Rep.genericEncodeJson(genericEquipment)(Data_Argonaut_Encode_Generic_Rep.encodeRepSum(Data_Argonaut_Encode_Generic_Rep.encodeRepConstructor(new Data_Symbol.IsSymbol(function () {
          return "Helmet";
      }))(Data_Argonaut_Encode_Generic_Rep.encodeRepArgsArgument(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Game_Data_Experience.encodeJsonLevel)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Game_Data_Stats.encodeJsonStats)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          return "stats";
      }))())(new Data_Symbol.IsSymbol(function () {
          return "name";
      }))())(new Data_Symbol.IsSymbol(function () {
          ...
          return "LongSword";
      }))(Data_Argonaut_Encode_Generic_Rep.encodeRepArgsArgument(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonInt)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Game_Data_Experience.encodeJsonLevel)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Game_Data_Stats.encodeJsonStats)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          return "stats";
      }))())(new Data_Symbol.IsSymbol(function () {
          return "name";
      }))())(new Data_Symbol.IsSymbol(function () {
  ...
  var decodeJsonEquipment = new Data_Argonaut_Decode_Class.DecodeJson(function (a) {
      return Data_Argonaut_Decode_Generic_Rep.genericDecodeJson(genericEquipment)(Data_Argonaut_Decode_Generic_Rep.decodeRepSum(Data_Argonaut_Decode_Generic_Rep.decodeRepConstructorArg(new Data_Symbol.IsSymbol(function () {
          return "Helmet";
      }))(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Game_Data_Experience.decodeJsonLevel)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Game_Data_Stats.decodeJsonStats)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          return "stats";
      }))()())(new Data_Symbol.IsSymbol(function () {
          return "name";
      }))()())(new Data_Symbol.IsSymbol(function () {
...
(function($PS) {
  ...
  var Data_Symbol = $PS["Data.Symbol"];
  var Data_Tuple = $PS["Data.Tuple"];
  var Game_Data_Character_GearSlot = $PS["Game.Data.Character.GearSlot"];
  var Game_Data_Experience = $PS["Game.Data.Experience"];
  ...
  var level = function (v) {
      return Game_Data_Experience.levelofExperience(v.value0.xp);
  };
  ...
  var equippedStats = function (equiped) {
      var itemStatsOrEmpty = function (item) {
          ...
          throw new Error("Failed pattern match at Game.Data.Character (line 107, column 27 - line 109, column 26): " + [ item.constructor.name ]);
      };
      var equipedItems = Data_Array.fromFoldable(Data_List_Types.foldableList)(Data_Map_Internal.values(equiped));
      return Data_Functor.map(Data_Functor.functorArray)(itemStatsOrEmpty)(equipedItems);
  };
  var totalStats = function (v) {
      var allStats = Data_Semigroup.append(Data_Semigroup.semigroupArray)([ v.value0.stats ])(equippedStats(v.value0.equipped));
  ...
  var maxhp = function (characterSheet) {
      ...
      var hp$prime = (10 * v | 0) * Data_Int.floor(Data_Int.toNumber(v1.value0.end) * 1.5) | 0;
      return hp$prime;
  };
          ...
          return function (stats) {
              return function (xp) {
                  var sheet = {
                      ...
                      equipped: Data_Map_Internal.fromFoldable(Game_Data_Character_GearSlot.ordGearSlot)(Data_Foldable.foldableArray)([ Data_Tuple.Tuple.create(Game_Data_Character_GearSlot.Head.value)(Data_Maybe.Just.create(new Game_Data_Item_Equipment.Helmet({
                          name: "Howler",
                          description: "Nasty looking thing",
                          stats: Game_Data_Stats.mkStats(2)(4)(0)(0)(0),
                          levelRequirement: 0
                      }))), new Data_Tuple.Tuple(Game_Data_Character_GearSlot.Chest.value, Data_Maybe.Nothing.value), new Data_Tuple.Tuple(Game_Data_Character_GearSlot.Hands.value, Data_Maybe.Nothing.value), new Data_Tuple.Tuple(Game_Data_Character_GearSlot.Leggs.value, Data_Maybe.Nothing.value), new Data_Tuple.Tuple(Game_Data_Character_GearSlot.Feet.value, Data_Maybe.Nothing.value), new Data_Tuple.Tuple(Game_Data_Character_GearSlot.MainHand.value, Data_Maybe.Nothing.value), new Data_Tuple.Tuple(Game_Data_Character_GearSlot.OffHand.value, Data_Maybe.Nothing.value) ])
                  };
  ...
  var showCharacterSheet = new Data_Show.Show(function (v) {
      var v1 = totalStats(new CharacterSheet(v.value0));
      var maxhp$prime = maxhp(new CharacterSheet(v.value0));
      return "Name:          " + (v.value0.name + ("\x0a" + ("Level:         " + (Data_Show.show(Game_Data_Experience.showLevel)(Game_Data_Experience.levelofExperience(v.value0.xp)) + ("\x0a" + ("Class:         " + (Data_Show.show(Game_Data_Role.showRole)(v.value0.role) + ("\x0a" + ("Experience:    " + (Data_Show.show(Game_Data_Experience.showExperience)(v.value0.xp) + ("\x0a" + ("Agility:       " + (Data_Show.show(Game_Data_Stats.showAgility)(v1.value0.agi) + ("\x0a" + ("Strength:      " + (Data_Show.show(Game_Data_Stats.showStrength)(v1.value0.str) + ("\x0a" + ("Endurance:     " + (Data_Show.show(Game_Data_Stats.showEndurance)(v1.value0.end) + ("\x0a" + ("Wisdom:        " + (Data_Show.show(Game_Data_Stats.showWisdom)(v1.value0.wis) + ("\x0a" + ("Intelligence:  " + (Data_Show.show(Game_Data_Stats.showIntelligence)(v1["value0"]["int"]) + ("\x0a" + ("HP:            " + (Data_Show.show(Data_Show.showInt)(v.value0.hp) + ("/" + (Data_Show.show(Data_Show.showInt)(maxhp$prime) + "\x0a"))))))))))))))))))))))))))))));
  });
  var encodeJsonCharacterSheet = new Data_Argonaut_Encode_Class.EncodeJson(function (a) {
      return Data_Argonaut_Encode_Generic_Rep.genericEncodeJson(genericCharacterSheet)(Data_Argonaut_Encode_Generic_Rep.encodeRepConstructor(new Data_Symbol.IsSymbol(function () {
          return "CharacterSheet";
      }))(Data_Argonaut_Encode_Generic_Rep.encodeRepArgsArgument(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeMap(Game_Data_Character_GearSlot.ordGearSlot)(Game_Data_Character_GearSlot.encodeJsonGearSlot)(Data_Argonaut_Encode_Class.encodeJsonMaybe(Game_Data_Item_Equipment.encodeJsonEquipment)))(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonInt)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonArray(Game_Data_Item_Equipment.encodeJsonEquipment))(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          return "equipment";
  ...
  var decodeJsonCharacterSheet = new Data_Argonaut_Decode_Class.DecodeJson(function (a) {
      return Data_Argonaut_Decode_Generic_Rep.genericDecodeJson(genericCharacterSheet)(Data_Argonaut_Decode_Generic_Rep.decodeRepConstructorArg(new Data_Symbol.IsSymbol(function () {
          return "CharacterSheet";
      }))(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeMap(Game_Data_Character_GearSlot.ordGearSlot)(Game_Data_Character_GearSlot.decodeJsonGearSlot)(Data_Argonaut_Decode_Class.decodeJsonMaybe(Game_Data_Item_Equipment.decodeJsonEquipment)))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonInt)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeArray(Game_Data_Item_Equipment.decodeJsonEquipment))(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          return "equipment";
      }))()())())(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Game_Data_Role.decodeJsonRole)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Game_Data_Stats.decodeJsonStats)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Game_Data_Experience.decodeJsonExperience)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          return "xp";
      }))()())(new Data_Symbol.IsSymbol(function () {
          return "stats";
      }))()())(new Data_Symbol.IsSymbol(function () {
...
(function($PS) {
  ...
  var getCharacter = function (state) {
      if (state instanceof Exploration) {
          return state.value0.character;
      };
      if (state instanceof Combat) {
          return state.value0.character;
      };
      if (state instanceof Dialogue) {
          return state.value0.character;
      };
      throw new Error("Failed pattern match at Game.Loop.Playing.PlayingState (line 33, column 3 - line 36, column 30): " + [ state.constructor.name ]);
  };
  var genericPlayingState = new Data_Generic_Rep.Generic(function (x) {
      ...
      if (x instanceof Dialogue) {
          return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(x.value0));
      };
      throw new Error("Failed pattern match at Game.Loop.Playing.PlayingState (line 38, column 1 - line 38, column 61): " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
          return new Exploration(x.value0);
      };
      if (x instanceof Data_Generic_Rep.Inr && x.value0 instanceof Data_Generic_Rep.Inl) {
          return new Combat(x.value0.value0);
      };
      if (x instanceof Data_Generic_Rep.Inr && x.value0 instanceof Data_Generic_Rep.Inr) {
          return new Dialogue(x.value0.value0);
      };
      throw new Error("Failed pattern match at Game.Loop.Playing.PlayingState (line 38, column 1 - line 38, column 61): " + [ x.constructor.name ]);
  });                                              
  var encodePlayingState = new Data_Argonaut_Encode_Class.EncodeJson(function (a) {
      return Data_Argonaut_Encode_Generic_Rep.genericEncodeJson(genericPlayingState)(Data_Argonaut_Encode_Generic_Rep.encodeRepSum(Data_Argonaut_Encode_Generic_Rep.encodeRepConstructor(new Data_Symbol.IsSymbol(function () {
          return "Exploration";
      }))(Data_Argonaut_Encode_Generic_Rep.encodeRepArgsArgument(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Game_Data_Character.encodeJsonCharacterSheet)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Game_Data_Location.encodeJsonLocation)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonInt)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          return "turn";
      }))())(new Data_Symbol.IsSymbol(function () {
          return "location";
      }))())(new Data_Symbol.IsSymbol(function () {
  ...
  var decodePlayingState = new Data_Argonaut_Decode_Class.DecodeJson(function (a) {
      return Data_Argonaut_Decode_Generic_Rep.genericDecodeJson(genericPlayingState)(Data_Argonaut_Decode_Generic_Rep.decodeRepSum(Data_Argonaut_Decode_Generic_Rep.decodeRepConstructorArg(new Data_Symbol.IsSymbol(function () {
          return "Exploration";
      }))(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Game_Data_Character.decodeJsonCharacterSheet)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Game_Data_Location.decodeJsonLocation)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonInt)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          return "turn";
      }))()())(new Data_Symbol.IsSymbol(function () {
          return "location";
      }))()())(new Data_Symbol.IsSymbol(function () {
...
(function($PS) {
  ...
  var encodeJsonGameState = new Data_Argonaut_Encode_Class.EncodeJson(function (a) {
      return Data_Argonaut_Encode_Generic_Rep.genericEncodeJson(genericGameState)(Data_Argonaut_Encode_Generic_Rep.encodeRepSum(Data_Argonaut_Encode_Generic_Rep.encodeRepConstructor(new Data_Symbol.IsSymbol(function () {
          ...
          return "Playing";
      }))(Data_Argonaut_Encode_Generic_Rep.encodeRepArgsArgument(Game_Loop_Playing_PlayingState.encodePlayingState)))(Data_Argonaut_Encode_Generic_Rep.encodeRepConstructor(new Data_Symbol.IsSymbol(function () {
          return "CreatingCharacter";
      }))(Data_Argonaut_Encode_Generic_Rep.encodeRepArgsArgument(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonMaybe(Data_Argonaut_Encode_Class.encodeJsonJString))(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonMaybe(Game_Data_Role.encodeJsonRole))(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          return "role";
      }))())(new Data_Symbol.IsSymbol(function () {
          return "name";
      }))())())))))(a);
  ...
  var decodeJsonGameState = new Data_Argonaut_Decode_Class.DecodeJson(function (a) {
      return Data_Argonaut_Decode_Generic_Rep.genericDecodeJson(genericGameState)(Data_Argonaut_Decode_Generic_Rep.decodeRepSum(Data_Argonaut_Decode_Generic_Rep.decodeRepConstructorNoArgs(new Data_Symbol.IsSymbol(function () {
          ...
          return "Playing";
      }))(Game_Loop_Playing_PlayingState.decodePlayingState))(Data_Argonaut_Decode_Generic_Rep.decodeRepConstructorArg(new Data_Symbol.IsSymbol(function () {
          return "CreatingCharacter";
      }))(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonMaybe(Data_Argonaut_Decode_Class.decodeJsonString))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonMaybe(Game_Data_Role.decodeJsonRole))(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          return "role";
      }))()())(new Data_Symbol.IsSymbol(function () {
          return "name";
      }))()())()))))(a);
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Game_Engine.bindGame)(Game_Engine.log(Game_Engine.engineEngineM)("Chose class: " + (Data_Show.show(Game_Data_Role.showRole)(role) + "\x0a")))(function () {
                          return Control_Bind.bind(Game_Engine.bindGame)(allocateStats(state))(function (stats) {
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Game_Engine.bindGame)(Game_Engine.log(Game_Engine.engineEngineM)("-----------------------------------"))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Game_Engine.bindGame)(Game_Engine.log(Game_Engine.engineEngineM)(Data_Show.show(Game_Data_Character.showCharacterSheet)(characterSheet)))(function () {
...
(function($PS) {
  ...
  var toChars = (function () {
      var $55 = Data_Array.toUnfoldable(Data_List_Types.unfoldableList);
      return function ($56) {
          return $55(Data_String_CodeUnits.toCharArray($56));
      };
  })();
  ...
  var functorParser = new Data_Functor.Functor(function (f) {
      return function (p) {
          return new Parser(function (s) {
              ...
              throw new Error("Failed pattern match at Lib.Parser (line 30, column 26 - line 32, column 29): " + [ v.constructor.name ]);
          });
      };
  });
  var fromChars = (function () {
      var $57 = Data_Array.fromFoldable(Data_List_Types.foldableList);
      return function ($58) {
          return Data_String_CodeUnits.fromCharArray($57($58));
      };
  })();
      ...
      return new Control_Bind.Bind(function () {
          ...
          return function (g) {
              return new Parser(function (s) {
                  ...
                  throw new Error("Failed pattern match at Lib.Parser (line 46, column 27 - line 48, column 29): " + [ v.constructor.name ]);
              });
          };
      });
  };
          ...
          return function (f) {
              return new Parser(function (s) {
                  ...
                  if (v instanceof Data_Either.Right) {
                      ...
                      throw new Error("Failed pattern match at Lib.Parser (line 36, column 27 - line 38, column 31): " + [ v1.constructor.name ]);
                  };
                  if (v instanceof Data_Either.Left) {
                      return new Data_Either.Left(v.value0);
                  };
                  throw new Error("Failed pattern match at Lib.Parser (line 35, column 29 - line 39, column 29): " + [ v.constructor.name ]);
              });
          };
      });
  };
  ...
  var anyChar = (function () {
      var f = function (v) {
          ...
          throw new Error("Failed pattern match at Lib.Parser (line 77, column 5 - line 77, column 82): " + [ v.constructor.name ]);
      };
      return new Parser(function ($59) {
          return f(toChars($59));
      });
  })();
  ...
  var literal = function (s) {
      return Data_Functor.map(functorParser)(fromChars)((function () {
          ...
          throw new Error("Failed pattern match at Lib.Parser (line 91, column 17 - line 96, column 23): " + [ v.constructor.name ]);
      })());
  };
      ...
      return new Control_Alt.Alt(function () {
          ...
          return function (b) {
              return new Parser(function (s) {
                  ...
                  throw new Error("Failed pattern match at Lib.Parser (line 53, column 26 - line 55, column 28): " + [ v.constructor.name ]);
              });
          };
      });
  };
  var anySpace = Control_Bind.bind(bindParser(applyParser(functorParser)))(Data_List.many(alternativeParser(altParser(functorParser))(plusParser(altParser(functorParser))))(lazyParser)(ternary(Data_Char_Unicode.isSpace)))(function (spaces$prime) {
  ...
  var finiteString = Control_Bind.bind(bindParser(applyParser(functorParser)))(Data_List.many(alternativeParser(altParser(functorParser))(plusParser(altParser(functorParser))))(lazyParser)(ternary((function () {
      ...
      return function ($61) {
          return $60(Data_Char_Unicode.isSpace($61));
      };
  })())))(function (s) {
      return Control_Applicative.pure(applicativeParser(applyParser(functorParser)))(fromChars(s));
  });
  var someSpace = Control_Bind.bind(bindParser(applyParser(functorParser)))(Data_List.some(alternativeParser(altParser(functorParser))(plusParser(altParser(functorParser))))(lazyParser)(ternary(Data_Char_Unicode.isSpace)))(function (spaces$prime) {
      return Control_Applicative.pure(applicativeParser(applyParser(functorParser)))(fromChars(spaces$prime));
  });
...
(function($PS) {
  ...
  var answer = Control_Bind.bind(Lib_Parser.bindParser(Lib_Parser.applyParser(Lib_Parser.functorParser)))(Lib_Parser.anySpace)(function () {
      return Control_Bind.bind(Lib_Parser.bindParser(Lib_Parser.applyParser(Lib_Parser.functorParser)))(Lib_Parser.literal("answer:"))(function () {
          return Control_Bind.bind(Lib_Parser.bindParser(Lib_Parser.applyParser(Lib_Parser.functorParser)))(Lib_Parser.someSpace)(function () {
              return Control_Bind.bind(Lib_Parser.bindParser(Lib_Parser.applyParser(Lib_Parser.functorParser)))(Lib_Parser.finiteString)(function (answer$prime) {
                  return Control_Applicative.pure(Lib_Parser.applicativeParser(Lib_Parser.applyParser(Lib_Parser.functorParser)))(new Game_Syntax_Spec.Answer(answer$prime));
              });
          });
      });
  });
  ...
  //
  var actionParser = Control_Alt.alt(Lib_Parser.altParser(Lib_Parser.functorParser))(Control_Alt.alt(Lib_Parser.altParser(Lib_Parser.functorParser))(Control_Alt.alt(Lib_Parser.altParser(Lib_Parser.functorParser))(Control_Alt.alt(Lib_Parser.altParser(Lib_Parser.functorParser))(Control_Alt.alt(Lib_Parser.altParser(Lib_Parser.functorParser))(Control_Alt.alt(Lib_Parser.altParser(Lib_Parser.functorParser))(move)(look))(consume))(take))(openCharacterSheet))(Data_Functor.map(Lib_Parser.functorParser)(Game_Syntax_Spec.Combat.create)(combatParser)))(Data_Functor.map(Lib_Parser.functorParser)(Game_Syntax_Spec.Dialogue.create)(dialogueParser));
  ...
  var playing = function (state) {
      return function (action) {
              ...
              return Control_Bind.bind(Game_Engine.bindGame)(Game_Engine.prompt(Game_Engine.engineEngineM))(function (input$prime) {
                  ...
                  if (v instanceof Data_Either.Right) {
                      if (v.value0.value0 instanceof Game_Syntax_Spec.Save) {
                          return Control_Bind.bind(Game_Engine.bindGame)(Effect_Aff_Class.liftAff(Game_Engine.monadAffGame)(Engine_SaveGames.saveGame(v.value0.value0.value0)(new Game_GameState.Playing(state))))(function (saved) {
                      ...
                      if (v.value0.value0 instanceof Game_Syntax_Spec.Action) {
                          return playing(state)(v.value0.value0.value0);
                      };
                      throw new Error("Failed pattern match at Game.Loop.Playing.PlayingLoop (line 37, column 11 - line 48, column 41): " + [ v.value0.value0.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Game.Loop.Playing.PlayingLoop (line 31, column 7 - line 48, column 41): " + [ v.constructor.name ]);
              });
          };
          if (action instanceof Game_Syntax_Spec.Look) {
              if (state instanceof Game_Loop_Playing_PlayingState.Exploration) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Game_Engine.bindGame)(Game_Engine.log(Game_Engine.engineEngineM)(state.value0.location.value0.description + "\x0a"))(function () {
                      return playing(state)(Game_Syntax_Spec.Idle.value);
                  });
              };
              return playing(state)(Game_Syntax_Spec.Idle.value);
          ...
          if (action instanceof Game_Syntax_Spec.OpenCharacterSheet) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Game_Engine.bindGame)(Game_Engine.log(Game_Engine.engineEngineM)(Data_Show.show(Game_Data_Character.showCharacterSheet)(Game_Loop_Playing_PlayingState.getCharacter(state))))(function () {
                  return playing(state)(Game_Syntax_Spec.Idle.value);
              });
          };
          return Control_Bind.discard(Control_Bind.discardUnit)(Game_Engine.bindGame)(Game_Engine.log(Game_Engine.engineEngineM)("I dont understand that command."))(function () {
...
(function($PS) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Engine_Input.empty))(function (input) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Engine_Log.empty))(function (log) {
          ...
          return Control_Bind.bind(Effect_Aff.bindAff)(Engine_SaveGames.loadGame("blytz"))(function (c) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
                  return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(Components_Game.gameComponent(Effect_Aff.monadEffectAff)(environment)(c))(Data_Unit.unit)(body))(function (halogenIO) {
