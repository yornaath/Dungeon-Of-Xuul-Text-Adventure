      ...
      return function (environment) {
          return function (initialGameState) {
              var render = function (state) {
                  return Halogen_HTML_Elements.div([ Components_Utils.css("container mx-auto px-4 pt-4") ])([ Halogen_HTML_Elements.input([ Components_Utils.css("bg-blue-500"), Halogen_HTML_Properties.value(state.currentInput), Halogen_HTML_Events.onValueInput(function (str) {
                      return new Data_Maybe.Just(new Typing(str));
                  }), Halogen_HTML_Events.onKeyUp(function (e) {
                      var $9 = Web_UIEvent_KeyboardEvent.code(e) === "Enter";
                      if ($9) {
              ...
              var handleAction = function (v) {
                  ...
                  if (v instanceof Log) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))("LOG: " + v.value0))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                      });
                  };
                  ...
                  throw new Error("Failed pattern match at Components.Game (line 75, column 18 - line 95, column 16): " + [ v.constructor.name ]);
              };
...
(function($PS) {
  ...
  var genericGameState = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Game.GameState (line 19, column 1 - line 19, column 56): " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
...
(function($PS) {
  ...
  var engineEngineM = new EngineM(function () {
      ...
      return Control_Bind.bind(bindGame)(Control_Monad_Reader_Class.asks(monadAskEngine(Type_Equality.refl))(function (v) {
          ...
          return Control_Bind.discard(Control_Bind.discardUnit)(bindGame)(Effect_Class.liftEffect(monadEffectGame)(Queue_Types.put(Queue.queueQueue)(logQueue)(str)))(function () {
      ...
      var takeNext = Effect_Aff.makeAff(function (cb) {
          return function __do() {
      ...
      return Control_Bind.bind(bindGame)(Effect_Aff_Class.liftAff(monadAffGame)(takeNext))(function (nextLine) {
      ...
      return Control_Bind.bind(Game_Engine.bindGame)(Game_Engine.prompt(Game_Engine.engineEngineM))(function (input) {
          ...
          if (v1 instanceof Data_Maybe.Just) {
              ...
              if (reply instanceof Data_Maybe.Nothing) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Game_Engine.bindGame)(Effect_Class_Console.log(Game_Engine.monadEffectGame)("Not a valid choice."))(function () {
  ...
  var dialogue = function (state) {
      return function (dialogue$prime) {
          return function (index) {
              ...
              if (v instanceof Data_Maybe.Just) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Game_Engine.bindGame)(Effect_Class_Console.log(Game_Engine.monadEffectGame)(renderChoicePoint(v.value0)))(function () {
                      return Control_Bind.bind(Game_Engine.bindGame)(askForReply(v.value0))(function (reply) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Game_Engine.bindGame)(Effect_Class_Console.log(Game_Engine.monadEffectGame)(state.character.value0.name + (" \u201c" + (reply.text + "\u201d"))))(function () {
                              ...
                              if (reply.next instanceof Data_Maybe.Nothing) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Game_Engine.bindGame)(Effect_Class_Console.log(Game_Engine.monadEffectGame)("[dialogue ended]\x0a"))(function () {
                                      return Control_Applicative.pure(Game_Engine.applicativeGame)(new Game_GameState.Playing(state));
                                  });
                              };
                              throw new Error("Failed pattern match at Game.Loop.Playing.Dialogue.DialogueLoop (line 26, column 7 - line 31, column 31): " + [ reply.next.constructor.name ]);
                          });
                      });
                  });
              };
  ...
  var playing = function (state) {
      return function (input) {
          ...
          if (input.length === 1 && input[0] === "talk") {
              return Game_Loop_Playing_Dialogue_DialogueLoop.dialogue(state)(testDialogue)(1);
          };
          if (input.length === 0) {
              return Control_Bind.bind(Game_Engine.bindGame)(Game_Engine.prompt(Game_Engine.engineEngineM))(function (input$prime) {
                  var command = Data_String_Common.split(Data_Newtype.wrap(Data_String_Pattern.newtypePattern)(" "))(input$prime);
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Data_Functor["void"](Effect_Aff.functorAff)(Effect_Aff.forkAff((function () {
                      var gameLoopRunner = function (currentState) {
                          return Control_Bind.bind(Effect_Aff.bindAff)(Game_Engine.runEngine(environment)(Game_Loop_Root.gameLoop(currentState)))(function (newState) {
                              return Control_Bind.bind(Effect_Aff.bindAff)(halogenIO.query(Halogen_Query.tell(Components_Game.Turn.create(newState))))(function () {
