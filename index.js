...
(function($PS) {
      ...
      var go = function (acc) {
          return function (v) {
              ...
              if (v instanceof Data_List_Types.Cons) {
                  return function __do() {
                      var n = v.value0();
                      return go(acc + n | 0)(v.value1)();
                  };
              };
              throw new Error("Failed pattern match at Data.Die (line 36, column 3 - line 36, column 47): " + [ acc.constructor.name, v.constructor.name ]);
          };
      };
      return go(0)(ds);
  };
  var showDie = new Data_Show.Show(function (v) {
      return "d" + Data_Show.show(Data_Show.showInt)(v.value0);
  });
  var rollDie = function (v) {
      return Effect_Random.randomInt(1)(v.value0);
  };
  var tossDies = function (v) {
      return Data_Functor.map(Data_List_Types.functorList)(rollDie)(v);
  };
  var eqDie = new Data_Eq.Eq(function (v) {
      return function (v1) {
  ...
  var d6 = new Die(6);
  var d20 = new Die(20);
  var allDies = new Data_List_Types.Cons(d6, new Data_List_Types.Cons(d20, Data_List_Types.Nil.value));
  exports["allDies"] = allDies;
  exports["tossDies"] = tossDies;
  exports["sumDies"] = sumDies;
  exports["showDie"] = showDie;
  exports["eqDie"] = eqDie;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Components.DieSelector"] = $PS["Components.DieSelector"] || {};
  var exports = $PS["Components.DieSelector"];
  ...
  var Deselect = (function () {
      function Deselect(value0) {
          this.value0 = value0;
      };
      Deselect.create = function (value0) {
          return new Deselect(value0);
      };
      return Deselect;
  })();
  var dieSelector = function (dictMonadEffect) {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([  ])(Data_Functor.map(Data_Functor.functorArray)(function (d) {
              return Halogen_HTML_Elements.div([ Components_Utils.css("flex") ])([ Halogen_HTML_Elements.button([ Components_Utils.css("p-1"), Halogen_HTML_Events.onClick(function (e) {
                  return new Data_Maybe.Just(new Select(d));
              }) ])([ Halogen_HTML_Core.text("+") ]), Halogen_HTML_Elements.div([ Components_Utils.css("p-1") ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Die.showDie)(d)) ]), Halogen_HTML_Elements.button([ Components_Utils.css("p-1"), Halogen_HTML_Events.onClick(function (e) {
                  return new Data_Maybe.Just(new Deselect(d));
              }) ])([ Halogen_HTML_Core.text("-") ]) ]);
          })(Data_Array.fromFoldable(Data_List_Types.foldableList)(Data_Die.allDies))), Halogen_HTML_Elements.div([ Components_Utils.css("flex") ])(Data_Functor.map(Data_Functor.functorArray)(function (d) {
              return Halogen_HTML_Elements.div([ Components_Utils.css("mr-2 p-1") ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Die.showDie)(d)) ]);
          })(Data_Array.fromFoldable(Data_List_Types.foldableList)(state.selected))) ]);
      };
      var initialState = function (v) {
          return {
              selected: Data_List_Types.Nil.value
          };
      };
      var handleQuery = function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(new Data_Maybe.Just(v.value0(v1.selected)));
          });
      };
      var handleAction = function (v) {
          if (v instanceof Select) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  return {
                      selected: Data_List.snoc(state.selected)(v.value0)
                  };
              }))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Halogen_Query_HalogenM.raise(v1.selected);
                  });
              });
          };
          if (v instanceof Deselect) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  return {
                      selected: Data_List["delete"](Data_Die.eqDie)(v.value0)(state.selected)
                  };
              }))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Halogen_Query_HalogenM.raise(v1.selected);
          ...
          throw new Error("Failed pattern match at Components.DieSelector (line 77, column 18 - line 85, column 25): " + [ v.constructor.name ]);
      };
  ...
  var _dieselector = Data_Symbol.SProxy.value;
  exports["_dieselector"] = _dieselector;
  exports["GetSelected"] = GetSelected;
  exports["dieSelector"] = dieSelector;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
...
(function($PS) {
  ...
  var exports = $PS["Components.App"];
  var Components_DieSelector = $PS["Components.DieSelector"];
  var Components_Utils = $PS["Components.Utils"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Die = $PS["Data.Die"];
  ...
  var OnSelectedDie = (function () {
      function OnSelectedDie(value0) {
          this.value0 = value0;
      };
      OnSelectedDie.create = function (value0) {
          return new OnSelectedDie(value0);
      };
      return OnSelectedDie;
  })();
  var appComponent = function (dictMonadEffect) {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Components_Utils.css("container mx-auto px-4 pt-4") ])([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "dieselector";
          }))(Data_Ord.ordInt)(Components_DieSelector["_dieselector"])(1)(Components_DieSelector.dieSelector(dictMonadEffect))({})(function ($7) {
              return Data_Maybe.Just.create(OnSelectedDie.create($7));
          }), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (e) {
              return new Data_Maybe.Just(Roll.value);
          }) ])([ Halogen_HTML_Core.text("roll") ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(state)) ]) ]);
      };
      var initialState = function (v) {
          return 0;
      };
      var handleAction = function (v) {
          if (v instanceof Roll) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                  return "dieselector";
              }))(Data_Ord.ordInt)(Components_DieSelector["_dieselector"])(1)(Halogen_Query.request(Components_DieSelector.GetSelected.create)))(function (selectedDiesQuery) {
                  var dies = Data_Maybe.fromMaybe(Data_List_Types.Nil.value)(selectedDiesQuery);
                  var tossed = Data_Die.tossDies(dies);
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(Data_Die.sumDies(tossed)))(function (sum) {
          ...
          if (v instanceof OnSelectedDie) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  return s;
              });
          };
          throw new Error("Failed pattern match at Components.App (line 43, column 18 - line 51, column 24): " + [ v.constructor.name ]);
      };
      return Halogen_Component.mkComponent({
          initialState: initialState,
          render: render,
...
(function($PS) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(Components_App.appComponent(Effect_Aff.monadEffectAff))(Data_Unit.unit)(body);
  }));
  exports["main"] = main;
})(PS);
PS["Main"].main();