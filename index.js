...
(function($PS) {
  ...
  var showLevel = new Data_Show.Show(function (v) {
      return "Level " + Data_Show.show(Data_Show.showInt)(v);
  });
  var showExperience = new Data_Show.Show(function (v) {
      return "Experience " + Data_Show.show(Data_Show.showInt)(v);
  });
...
(function($PS) {
  "use strict";
  $PS["Data.Item"] = $PS["Data.Item"] || {};
  var exports = $PS["Data.Item"];
  var Data_Argonaut_Decode_Class = $PS["Data.Argonaut.Decode.Class"];
  var Data_Argonaut_Decode_Generic_Rep = $PS["Data.Argonaut.Decode.Generic.Rep"];
  var Data_Argonaut_Encode_Class = $PS["Data.Argonaut.Encode.Class"];
  var Data_Argonaut_Encode_Generic_Rep = $PS["Data.Argonaut.Encode.Generic.Rep"];
  ...
  var Chest = (function () {
      function Chest(value0) {
          this.value0 = value0;
      };
      Chest.create = function (value0) {
          return new Chest(value0);
      };
      return Chest;
  })();
  var Hands = (function () {
      function Hands(value0) {
          this.value0 = value0;
      };
      Hands.create = function (value0) {
          return new Hands(value0);
      };
      return Hands;
  })();
  var Leggs = (function () {
      function Leggs(value0) {
          this.value0 = value0;
      };
      Leggs.create = function (value0) {
          return new Leggs(value0);
      };
      return Leggs;
  })();
  var Feet = (function () {
      function Feet(value0) {
          this.value0 = value0;
      };
      Feet.create = function (value0) {
          return new Feet(value0);
      };
      return Feet;
  })();
  var unItem = function (item) {
      ...
      if (item instanceof Leggs) {
          return item.value0;
      };
      if (item instanceof Feet) {
          return item.value0;
      };
      throw new Error("Failed pattern match at Data.Item (line 44, column 3 - line 49, column 24): " + [ item.constructor.name ]);
  };
  var genericItem = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Data.Item (line 28, column 1 - line 28, column 45): " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
          return new Helmet(x.value0);
      };
      if (x instanceof Data_Generic_Rep.Inr && x.value0 instanceof Data_Generic_Rep.Inl) {
          return new Chest(x.value0.value0);
      };
      if (x instanceof Data_Generic_Rep.Inr && (x.value0 instanceof Data_Generic_Rep.Inr && x.value0.value0 instanceof Data_Generic_Rep.Inl)) {
          return new Hands(x.value0.value0.value0);
      };
      if (x instanceof Data_Generic_Rep.Inr && (x.value0 instanceof Data_Generic_Rep.Inr && (x.value0.value0 instanceof Data_Generic_Rep.Inr && x.value0.value0.value0 instanceof Data_Generic_Rep.Inl))) {
          return new Leggs(x.value0.value0.value0.value0);
      };
      if (x instanceof Data_Generic_Rep.Inr && (x.value0 instanceof Data_Generic_Rep.Inr && (x.value0.value0 instanceof Data_Generic_Rep.Inr && x.value0.value0.value0 instanceof Data_Generic_Rep.Inr))) {
          return new Feet(x.value0.value0.value0.value0);
      };
      throw new Error("Failed pattern match at Data.Item (line 28, column 1 - line 28, column 45): " + [ x.constructor.name ]);
  });                            
  var encodeJsonItem = new Data_Argonaut_Encode_Class.EncodeJson(function (a) {
      return Data_Argonaut_Encode_Generic_Rep.genericEncodeJson(genericItem)(Data_Argonaut_Encode_Generic_Rep.encodeRepSum(Data_Argonaut_Encode_Generic_Rep.encodeRepConstructor(new Data_Symbol.IsSymbol(function () {
          return "Helmet";
      }))(Data_Argonaut_Encode_Generic_Rep.encodeRepArgsArgument(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonInt)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Stats.encodeJsonStats)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          return "stats";
      }))())(new Data_Symbol.IsSymbol(function () {
          return "name";
      }))())(new Data_Symbol.IsSymbol(function () {
  ...
  var decodeJsonItem = new Data_Argonaut_Decode_Class.DecodeJson(function (a) {
      return Data_Argonaut_Decode_Generic_Rep.genericDecodeJson(genericItem)(Data_Argonaut_Decode_Generic_Rep.decodeRepSum(Data_Argonaut_Decode_Generic_Rep.decodeRepConstructorArg(new Data_Symbol.IsSymbol(function () {
          return "Helmet";
      }))(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonInt)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Stats.decodeJsonStats)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          return "stats";
      }))()())(new Data_Symbol.IsSymbol(function () {
          return "name";
      }))()())(new Data_Symbol.IsSymbol(function () {
...
(function($PS) {
  ...
  var unEquip = function (itemSlot) {
      return function (v) {
          var v1 = Data_String_Common.toLower(itemSlot);
          if (v1 === "helmet") {
              return Data_Either.Right.create(CharacterSheet.create({
                  name: v.value0.name,
                  stats: v.value0.stats,
                  role: v.value0.role,
                  xp: v.value0.xp,
                  hp: v.value0.hp,
                  inventory: v.value0.inventory,
                  equipped: {
                      helmet: Data_Maybe.Nothing.value,
                      chest: v.value0.equipped.chest,
                      hands: v.value0.equipped.hands,
                      leggs: v.value0.equipped.leggs,
                      feet: v.value0.equipped.feet
                  }
              }));
          };
          if (v1 === "chest") {
              return Data_Either.Right.create(CharacterSheet.create({
                  ...
                  inventory: v.value0.inventory,
                  equipped: {
                      helmet: v.value0.equipped.helmet,
          ...
          return new Data_Either.Left("no slot for " + itemSlot);
      };
  };
  ...
  var equippedStats = function (equipment) {
      var itemStatsOrEmpty = function (item) {
          if (item instanceof Data_Maybe.Just) {
              return (Data_Item.unItem(item.value0)).stats;
          };
          if (item instanceof Data_Maybe.Nothing) {
              return Data_Stats.emptyStats;
          };
          throw new Error("Failed pattern match at Data.Character (line 102, column 27 - line 104, column 26): " + [ item.constructor.name ]);
      };
      var equipedItems = [ equipment.helmet, equipment.chest, equipment.hands, equipment.leggs, equipment.feet ];
  ...
  var totalStats = function (v) {
      ...
      return Data_Foldable.foldl(Data_Foldable.foldableArray)(Data_Semigroup.append(Data_Stats.semigroupStats))(Data_Stats.emptyStats)(allStats);
  };
  var maxhp = function (characterSheet) {
      var v = Data_Experience.levelof(characterSheet.value0.xp);
          ...
          return function (stats) {
              return function (xp) {
                  var sheet = {
                      ...
                      inventory: [  ],
                      equipped: {
                          helmet: Data_Maybe.Just.create(new Data_Item.Helmet({
                              name: "Howler",
                              description: "Nasty looking thing",
                              stats: Data_Stats.mkStats(2)(4)(0)(0)(0),
                              levelRequirement: 0
                          })),
                          chest: Data_Maybe.Nothing.value,
                          hands: Data_Maybe.Nothing.value,
  ...
  var showCharacterSheet = new Data_Show.Show(function (v) {
      ...
      return "Name:          " + (v.value0.name + ("\x0a" + ("Level:         " + (Data_Show.show(Data_Experience.showLevel)(Data_Experience.levelof(v.value0.xp)) + ("\x0a" + ("Class:         " + (Data_Show.show(Data_Role.showRole)(v.value0.role) + ("\x0a" + ("Experience:    " + (Data_Show.show(Data_Experience.showExperience)(v.value0.xp) + ("\x0a" + ("Agility:       " + (Data_Show.show(Data_Stats.showAgility)(v1.value0.agi) + ("\x0a" + ("Strength:      " + (Data_Show.show(Data_Stats.showStrength)(v1.value0.str) + ("\x0a" + ("Endurance:     " + (Data_Show.show(Data_Stats.showEndurance)(v1.value0.end) + ("\x0a" + ("Wisdom:        " + (Data_Show.show(Data_Stats.showWisdom)(v1.value0.wis) + ("\x0a" + ("Intelligence:  " + (Data_Show.show(Data_Stats.showIntelligence)(v1["value0"]["int"]) + ("\x0a" + ("HP:            " + (Data_Show.show(Data_Show.showInt)(v.value0.hp) + ("/" + (Data_Show.show(Data_Show.showInt)(maxhp$prime) + "\x0a"))))))))))))))))))))))))))))));
  });
  var encodeJsonCharacterSheet = new Data_Argonaut_Encode_Class.EncodeJson(function (a) {
      return Data_Argonaut_Encode_Generic_Rep.genericEncodeJson(genericCharacterSheet)(Data_Argonaut_Encode_Generic_Rep.encodeRepConstructor(new Data_Symbol.IsSymbol(function () {
          return "CharacterSheet";
      }))(Data_Argonaut_Encode_Generic_Rep.encodeRepArgsArgument(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonMaybe(Data_Item.encodeJsonItem))(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonMaybe(Data_Item.encodeJsonItem))(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonMaybe(Data_Item.encodeJsonItem))(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonMaybe(Data_Item.encodeJsonItem))(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonMaybe(Data_Item.encodeJsonItem))(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          return "leggs";
      }))())(new Data_Symbol.IsSymbol(function () {
          return "helmet";
      }))())(new Data_Symbol.IsSymbol(function () {
          ...
          return "chest";
      }))())())(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonInt)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonArray(Data_Item.encodeJsonItem))(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Role.encodeJsonRole)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Stats.encodeJsonStats)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Experience.encodeJsonExperience)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          return "xp";
      }))())(new Data_Symbol.IsSymbol(function () {
          return "stats";
      }))())(new Data_Symbol.IsSymbol(function () {
  ...
  var decodeJsonCharacterSheet = new Data_Argonaut_Decode_Class.DecodeJson(function (a) {
      return Data_Argonaut_Decode_Generic_Rep.genericDecodeJson(genericCharacterSheet)(Data_Argonaut_Decode_Generic_Rep.decodeRepConstructorArg(new Data_Symbol.IsSymbol(function () {
          return "CharacterSheet";
      }))(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonMaybe(Data_Item.decodeJsonItem))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonMaybe(Data_Item.decodeJsonItem))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonMaybe(Data_Item.decodeJsonItem))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonMaybe(Data_Item.decodeJsonItem))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonMaybe(Data_Item.decodeJsonItem))(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          return "leggs";
      }))()())(new Data_Symbol.IsSymbol(function () {
          return "helmet";
      }))()())(new Data_Symbol.IsSymbol(function () {
                  ...
                  return Control_Bind.bind(Game_Engine.bindGame)(chooseRole(state))(function (role) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Game_Engine.bindGame)(Game_Engine.log(Game_Engine.engineEngineM)("Chose class: " + (Data_Show.show(Data_Role.showRole)(role) + "\x0a")))(function () {
                          return Control_Bind.bind(Game_Engine.bindGame)(allocateStats(state))(function (stats) {
                              var characterSheet = Data_Character.mkCharacterSheet(name)(role)(stats)(0);
...
(function($PS) {
  ...
  var playing = function (state) {
      return function (input) {
          ...
          if (input.length === 2 && input[0] === ":une") {
              var v = Data_Character.unEquip(input[1])(state.character);
              if (v instanceof Data_Either.Right) {
                  var newState = {
                      character: v.value0,
                      location: state.location,
              ...
              if (v instanceof Data_Either.Left) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Game_Engine.bindGame)(Game_Engine.log(Game_Engine.engineEngineM)(v.value0))(function () {
                      return playing(state)([  ]);
                  });
              };
              throw new Error("Failed pattern match at Game.Loop.Playing.PlayingLoop (line 38, column 7 - line 44, column 27): " + [ v.constructor.name ]);
          };
