          ...
          return function (initialGameState) {
              var render = function (state) {
                  return Halogen_HTML_Elements.div([ Components_Utils.css("container mx-auto px-4 pt-4") ])([ Halogen_HTML_Elements.div([ Components_Utils.css("console") ])([ Halogen_HTML_Elements.div([ Components_Utils.css("log") ])(Data_Functor.map(Data_Functor.functorArray)(function (logLine) {
                      ...
                      var $11 = Web_UIEvent_KeyboardEvent.code(e) === "Enter";
                      if ($11) {
              ...
              var handleQuery = function (v) {
                  ...
                  if (v instanceof Log) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                              ...
                              $18.log = Data_Semigroup.append(Data_Semigroup.semigroupArray)(state.log)([ v.value0 ]);
                              return $18;
                          }))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(new Data_Maybe.Just(v.value1));
                          });
                  ...
                  throw new Error("Failed pattern match at Components.Game (line 88, column 17 - line 95, column 23): " + [ v.constructor.name ]);
              };
              var handleAction = function (v) {
                  ...
                  throw new Error("Failed pattern match at Components.Game (line 97, column 18 - line 111, column 16): " + [ v.constructor.name ]);
              };
...
(function($PS) {
  ...
  var pickStat = function (statname) {
      return function (total) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Game_Engine.bindGame)(Game_Engine.log(Game_Engine.engineEngineM)("Choose " + (statname + (" (" + (Data_Show.show(Data_Show.showInt)(total) + "):\x0a ")))))(function () {
              return Control_Bind.bind(Game_Engine.bindGame)(Game_Engine.prompt(Game_Engine.engineEngineM))(function (numString) {
                  ...
                  if (num instanceof Data_Maybe.Nothing) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Game_Engine.bindGame)(Game_Engine.log(Game_Engine.engineEngineM)("Invalid Number"))(function () {
                  ...
                  if (num instanceof Data_Maybe.Just) {
                      ...
                      var $7 = newTotal < 0;
                      if ($7) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Game_Engine.bindGame)(Game_Engine.log(Game_Engine.engineEngineM)("You dont have that may points left, (" + (Data_Show.show(Data_Show.showInt)(total) + ") available")))(function () {
                              return pickStat(statname)(total);
                          });
                      };
                      return Control_Applicative.pure(Game_Engine.applicativeGame)(new Data_Tuple.Tuple(num.value0, newTotal));
                  };
                  throw new Error("Failed pattern match at Game.Loop.CharacterCreation (line 103, column 3 - line 113, column 37): " + [ num.constructor.name ]);
              });
          });
      };
  };
  var chooseRole = function (state) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Game_Engine.bindGame)(Game_Engine.log(Game_Engine.engineEngineM)("Choose a class(Warrior, Thief or Mage): \x0a"))(function () {
          return Control_Bind.bind(Game_Engine.bindGame)(Game_Engine.prompt(Game_Engine.engineEngineM))(function (roleInput) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Game_Engine.bindGame)(Game_Engine.log(Game_Engine.engineEngineM)(roleInput + " is not a recognized class."))(function () {
                              ...
                              return Control_Bind.bind(Game_Engine.bindGame)(pickStat("agility")(total))(function (v) {
                                  return Control_Bind.bind(Game_Engine.bindGame)(pickStat("strength")(v.value1))(function (v1) {
                                      return Control_Bind.bind(Game_Engine.bindGame)(pickStat("endurance")(v1.value1))(function (v2) {
                                          return Control_Bind.bind(Game_Engine.bindGame)(pickStat("wisdomw")(v2.value1))(function (v3) {
      ...
      return Control_Bind.bind(Game_Engine.bindGame)(Game_Engine.prompt(Game_Engine.engineEngineM))(function (input) {
          ...
          if (v1 instanceof Data_Maybe.Just) {
              ...
              if (reply instanceof Data_Maybe.Nothing) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Game_Engine.bindGame)(Game_Engine.log(Game_Engine.engineEngineM)("Not a valid choice."))(function () {
              ...
              if (v instanceof Data_Maybe.Just) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Game_Engine.bindGame)(Game_Engine.log(Game_Engine.engineEngineM)(renderChoicePoint(v.value0)))(function () {
                      return Control_Bind.bind(Game_Engine.bindGame)(askForReply(v.value0))(function (reply) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Game_Engine.bindGame)(Game_Engine.log(Game_Engine.engineEngineM)(state.character.value0.name + ("\u201c" + (reply.text + "\u201d"))))(function () {
          ...
          if (input.length === 1 && input[0] === "help") {
              return Control_Bind.discard(Control_Bind.discardUnit)(Game_Engine.bindGame)(Game_Engine.log(Game_Engine.engineEngineM)(":save savename -- Save a game by its name"))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Game_Engine.bindGame)(Game_Engine.log(Game_Engine.engineEngineM)(":exit -- Exit to main menu"))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Game_Engine.bindGame)(Game_Engine.log(Game_Engine.engineEngineM)(":c -- Inspect character"))(function () {
...
(function($PS) {
  ...
  var Queue = $PS["Queue"];
  var Queue_Types = $PS["Queue.Types"];                
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Queue["new"]))(function (input) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Queue["new"]))(function (log) {
          var environment = {
              input: input,
              log: log
          };
