...
(function($PS) {
  ...
  var showCharacter = function (c) {
      var v = totalStats(c);
      var maxhp$prime = maxhp(c);
      return "Name:          " + (c.name + ("\x0a" + ("Level:         " + (Data_Show.show(Game_Data_Experience.showLevel)(Game_Data_Experience.levelofExperience(c.xp)) + ("\x0a" + ("Class:         " + (Data_Show.show(Game_Data_Role.showRole)(c.role) + ("\x0a" + ("Experience:    " + (Data_Show.show(Game_Data_Experience.showExperience)(c.xp) + ("\x0a" + ("Agility:       " + (Data_Show.show(Game_Data_Stats.showStat)(v.agi) + ("\x0a" + ("Strength:      " + (Data_Show.show(Game_Data_Stats.showStat)(v.str) + ("\x0a" + ("Endurance:     " + (Data_Show.show(Game_Data_Stats.showStat)(v.end) + ("\x0a" + ("Wisdom:        " + (Data_Show.show(Game_Data_Stats.showStat)(v.wis) + ("\x0a" + ("Intelligence:  " + (Data_Show.show(Game_Data_Stats.showStat)(v["int"]) + ("\x0a" + ("HP:            " + (Data_Show.show(Data_Show.showInt)(c.hp) + ("/" + (Data_Show.show(Data_Show.showInt)(maxhp$prime) + "\x0a"))))))))))))))))))))))))))))));
  };
  ...
  var explorationLoop = function (state) {
      return function (action) {
          if (action instanceof Game_Syntax_Spec.Idle) {
              return Control_Bind.bind(Game_Engine.bindGame)(Game_Engine.prompt(Game_Engine.engineEngineM))(function (input$prime) {
                  ...
                  if (v instanceof Data_Either.Right) {
                      ...
                      throw new Error("Failed pattern match at Game.Loop.Playing.Exploration (line 34, column 11 - line 45, column 49): " + [ v.value0.value0.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Game.Loop.Playing.Exploration (line 28, column 7 - line 45, column 49): " + [ v.constructor.name ]);
              });
          };
          ...
          if (action instanceof Game_Syntax_Spec.OpenCharacterSheet) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Game_Engine.bindGame)(Game_Engine.log(Game_Engine.engineEngineM)(Game_Data_Character.showCharacter(state.character)))(function () {
                  return explorationLoop(state)(Game_Syntax_Spec.Idle.value);
              });
          };
          return Control_Bind.discard(Control_Bind.discardUnit)(Game_Engine.bindGame)(Game_Engine.log(Game_Engine.engineEngineM)("I dont understand that command."))(function () {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Data_Functor["void"](Effect_Aff.functorAff)(Effect_Aff.forkAff((function () {
                      var gameLoopRunner = function (currentState) {
                          return Control_Bind.bind(Effect_Aff.bindAff)(Game_Engine.runEngine(environment)(Game_Loop_Root.gameLoop(currentState)))(function (newState) {
                              return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff.delay(Data_Time_Duration.Milliseconds(Data_Int.toNumber(3000))))(function () {
